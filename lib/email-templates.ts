...
export const EMAIL_TEMPLATES: EmailTemplateDef[] = [
  ...
  {
    key: 'group_welcome_school',
    name: 'Bienvenue (école / cours)',
    description: 'Envoyé à un nouvel élève/membre qui rejoint une école de musique.',
    defaultSubject: 'Bienvenue aux cours de {{groupName}} !',
    defaultIntro: 'Bonjour {{memberName}},\n\nVous avez rejoint les cours de {{groupName}}. Bienvenue !',
    defaultOutro: 'Nous sommes ravis de vous compter parmi les élèves.',
    variables: [
      { key: 'memberName', description: 'Prénom du membre' },
      { key: 'groupName', description: "Nom de l'école / classe" },
    ],
  },
  {
    key: 'mastery_reminder',
    name: 'Relance niveau de maîtrise',
    description: 'Envoyé la veille d\'une répétition / d\'un cours aux membres dont les morceaux ne sont pas tous à 100 %.',
    defaultSubject: '🎯 {{groupName}} — mettez à jour votre niveau de maîtrise avant {{eventArticleLower}}',
    defaultIntro: 'Bonjour {{memberName}},\n\n{{eventArticleCap}} de {{groupName}} approche, et il vous reste {{songsRemaining}} morceau(x) qui ne sont pas encore à 100 % de maîtrise de votre côté.',
    defaultOutro: 'Prenez un instant pour mettre à jour votre niveau de maîtrise — ça aide {{collective}} à préparer la séance.',
    variables: [
      { key: 'memberName', description: 'Prénom du membre' },
      { key: 'groupName', description: 'Nom du groupe / de la classe' },
      { key: 'songsRemaining', description: 'Nombre de morceaux pas encore à 100 %' },
      { key: 'eventArticleCap', description: '« La répétition » ou « Le cours »' },
      { key: 'eventArticleLower', description: '« la répétition » ou « le cours »' },
      { key: 'collective', description: '« le groupe » ou « le prof »' },
    ],
  },
  {
    key: 'member_removed',
