...
export const DEFAULT_PLAN_SEEDS = [
  {
    ...
    hasFileSubmissions: true, hasMetronome: true, hasParoles: true, color: 'gray',
  },
  {
    ...
    hasFileSubmissions: true, hasMetronome: true, hasParoles: true, color: 'indigo',
  },
  {
    ...
    hasFileSubmissions: true, hasMetronome: true, hasParoles: true, color: 'purple',
  },
]
