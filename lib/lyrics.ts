...
export const COMMON_CHORDS: { group: string; chords: string[] }[] = [
  ...
  { group: 'Majeurs altérés', chords: ['Db', 'Eb', 'Gb', 'Ab', 'Bb', 'C#', 'F#'] },
  { group: 'Mineurs altérés', chords: ['C#m', 'Ebm', 'F#m', 'G#m', 'Bbm', 'D#m', 'Abm'] },
  { group: '7e', chords: ['C7', 'D7', 'E7', 'F7', 'G7', 'A7', 'B7'] },
  { group: 'Mineurs 7', chords: ['Cm7', 'Dm7', 'Em7', 'Fm7', 'Gm7', 'Am7', 'Bm7'] },
