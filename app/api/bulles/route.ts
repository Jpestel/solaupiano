...
export async function POST(req: NextRequest) {
  ...
  const bubble = await prisma.helpBubble.create({
    data: {
      ...
      anchorSelector: typeof b.anchorSelector === 'string' && b.anchorSelector ? b.anchorSelector.slice(0, 1000) : null,
      anchorDx: typeof b.anchorDx === 'number' && isFinite(b.anchorDx) ? b.anchorDx : null,
      anchorDy: typeof b.anchorDy === 'number' && isFinite(b.anchorDy) ? b.anchorDy : null,
      title,
      content,
