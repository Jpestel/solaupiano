            ...
            >
              {visiblePlans.map((p) => {
                ...
                const modules = [
                  ...
                  { icon: '💶', label: 'Comptabilité / caisse', ok: p.hasAccounting },
                  { icon: '💬', label: 'Tchat du groupe', ok: p.hasChat },
                  { icon: '📒', label: 'Ressources partagées', ok: p.hasSharedResources },
                  { icon: '🗓', label: 'Disponibilités', ok: p.hasUnavailabilities },
                  { icon: '📊', label: 'Sondages', ok: p.hasPolls },
